...
## 本番当日までの流れ
1. **課題3への挑戦:** 予選大会で開発したソフトウェアをベースに、課題3のクリア、タイム短縮に向けさらなる開発を加えていただきます。
2. **課題2への挑戦:** 大会運営から提供する実験データを用いて課題２(煙への対応)に取り組んでいただきます。
3. **事前練習会:** 自動運転車両のオペレーションの取得と、開発したソフトウェアの動作確認をしていただきます。
4. **本番当日:** 自動運転車両を走行させ、各課題に挑戦していただきます！

***課題2: 開発のための実験データについて***  
本選と同等の環境で測定したrosbagデータを提供しています。  
rosbagデータは以下のリンクからダウンロード可能です。
- [課題2 rosbagデータ ダウンロードリンク](https://drive.google.com/drive/folders/1sHhe7tHbbWgVLOOkFwQ0OR43jTVYWwtR?usp=drive_link)
