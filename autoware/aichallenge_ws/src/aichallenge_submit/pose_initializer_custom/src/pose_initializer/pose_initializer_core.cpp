  ...
  const Initialize::Service::Response::SharedPtr res)
{
  ...
  try {
    ...
    pose.pose.pose.position.x = 3827.6742619127863;
    pose.pose.pose.position.y = 73776.76156678918;
    pose.pose.pose.position.z = 19.626154385244764;
    pose.pose.pose.orientation.x = -0.0008439598631592582;
    pose.pose.pose.orientation.y = -0.0010035230204519293;
    pose.pose.pose.orientation.z = -0.9705418231711431;
    pose.pose.pose.orientation.w = 0.24092913926906093;
    if (ndt_) {
